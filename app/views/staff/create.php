                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="level" name="level" required>
                                ...
                                <option value="Manager" <?php echo (isset($_POST['level']) && $_POST['level'] === 'Manager') ? 'selected' : ''; ?>>Manager</option>
                                <option value="Technicien" <?php echo (isset($_POST['level']) && $_POST['level'] === 'Technicien') ? 'selected' : ''; ?>>Technicien</option>
                                <option value="Ouvrier" <?php echo (isset($_POST['level']) && $_POST['level'] === 'Ouvrier') ? 'selected' : ''; ?>>Ouvrier</option>
                    ...
                    <select class="form-select" id="planning_id" name="planning_id">
                        ...
                        <?php foreach ($plannings as $planning): ?>
                            <option value="<?php echo $planning['id']; ?>" 
                                    <?php echo (isset($_POST['planning_id']) && $_POST['planning_id'] == $planning['id']) ? 'selected' : ''; ?>>
